            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="family" class="col-md-4 col-form-label text-md-end">{{ __('نام خانوادگی') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6" style="margin-top: 10px;margin-left: 5px">
                                    <input type="radio" name="type" value="buy" checked><span> خریدار</span>
                                    <br>
                                    <input type="radio" name="type" value="sell"><span> فروشنده</span>
                            </div>
                        </div>
